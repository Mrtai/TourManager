            ...
            <section className="ftco-section testimony-section bg-light">
                <div className="container">
                    <div className="row justify-content-start">
                        <div className="col-md-5 heading-section ftco-animate fadeInUp ftco-animated">
                        ...
                        <div className="col-md-6 heading-section ftco-animate fadeInUp ftco-animated">
                                ...
                                <div className="col-md-12">
                                    <div className="carousel-testimony owl-carousel owl-loaded owl-drag">
                                        <div className="owl-stage-outer">
                                            <div className="owl-stage" style={{ transform: 'translate3d(-1620px, 0px, 0px)', transition: 'all 0.25s ease 0s', width: '3780px' }}>
                                                <div className="owl-item cloned" style={{ width: '540px' }}><div className="item">
                                                ...
                                                </div></div><div className="owl-item cloned" style={{ width: '540px' }}><div className="item">
                                                    <div className="testimony-wrap d-flex">
                                                ...
                                                </div></div><div className="owl-item" style={{ width: '540px' }}><div className="item">
                                                    <div className="testimony-wrap d-flex">
                                                ...
                                                </div></div><div className="owl-item active" style={{ width: '540px' }}><div className="item">
                                                    <div className="testimony-wrap d-flex">
                                                        <div className="user-img mb-5" style={{ backgroundImage: 'url(images/person_2.jpg)' }}>
                                                            <span className="quote d-flex align-items-center justify-content-center">
                                                                <i className="icon-quote-left" />
                                                ...
                                                </div></div></div></div><div className="owl-nav"><button role="presentation" className="owl-prev"><span className="ion-ios-arrow-back" /></button><button role="presentation" className="owl-next"><span className="ion-ios-arrow-forward" /></button></div><div className="owl-dots"><button className="owl-dot"><span /></button><button className="owl-dot active"><span /></button><button className="owl-dot"><span /></button></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
