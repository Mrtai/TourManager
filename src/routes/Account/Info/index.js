    ...
    return (
        <Router>
            <Row className="row-detail-account">
                ...
                <Col xs={24} md={18}>
                    <Switch>
                        <AuthorizedRoute path={`${match.url}/info`} component={asyncComponent(() => import("./info"))} />
                        <AuthorizedRoute path={`${match.url}/napoc`} component={asyncComponent(() => import("./napOC"))} />
                        <AuthorizedRoute path={`${match.url}/history`} component={asyncComponent(() => import("./history"))} />
                    </Switch>
                </Col>
            </Row>
        </Router>
